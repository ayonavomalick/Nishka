codeunit 60003 "NIMShowResponseMessage Method"
{
    procedure ShowResponseMessage(var Log: Record "NIMREST Log");
    var
        Handled: Boolean;
    begin
    ...
    local procedure DoShowResponseMessage(var Log: Record "NIMREST Log"; var Handled: Boolean);
    var
        Instr: Instream;
    ...
    local procedure OnBeforeShowResponseMessage(var Log: Record "NIMREST Log"; var Handled: Boolean);
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterShowResponseMessage(var Log: Record "NIMREST Log");
    begin
    end;
}