codeunit 60002 "NIMShowRequestMessage Method"
{
    procedure ShowRequestMessage(var Log: Record "NIMREST Log");
    var
        Handled: Boolean;
    begin
    ...
    local procedure DoShowRequestMessage(var Log: Record "NIMREST Log"; var Handled: Boolean)
    var
        Instr: Instream;
        RequestMessage: Text;
        TempText: Text;
    ...
    local procedure OnBeforeShowRequestMessage(var Log: Record "NIMREST Log"; var Handled: Boolean);
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterShowRequestMessage(var Log: Record "NIMREST Log");
    begin
    end;
}